                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Title</th> <th>Phone</th> <th>Body</th> <th>User_id</th> <th>Category_id</th> <th>Reply_count</th> <th>View_count</th> <th>Last_reply_user_id</th> <th>Order</th> <th>Excerpt</th> <th>Slug</th>
                        ...
                        <tbody>
                            @foreach($topics as $topic)
                                <tr>
                                    ...
                                    <td>{{$topic->title}}</td> <td>{{$topic->phone}}</td> <td>{{$topic->body}}</td> <td>{{$topic->user_id}}</td> <td>{{$topic->category_id}}</td> <td>{{$topic->reply_count}}</td> <td>{{$topic->view_count}}</td> <td>{{$topic->last_reply_user_id}}</td> <td>{{$topic->order}}</td> <td>{{$topic->excerpt}}</td> <td>{{$topic->slug}}</td>
